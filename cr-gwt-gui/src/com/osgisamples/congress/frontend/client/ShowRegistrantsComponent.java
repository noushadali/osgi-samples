...
public class ShowRegistrantsComponent extends UpdateableComposite {
	...
	public ShowRegistrantsComponent() {
		...
		composite.setStyleName("registrants-widget");
		titleBar.setStyleName("registrants-title");
	...
	private void showRegistrantsComponent(ArrayList registrants) {
		...
		if (registrants != null && !registrants.isEmpty()) {
			...
			registrantsGrid.addStyleName("registrants-grid");
			Label columnName = new Label("Name");
			columnName.setStyleName("registrants-column");
			Label columnRegNumber = new Label("Registrantion numer");
			columnRegNumber.setStyleName("registrants-column");
